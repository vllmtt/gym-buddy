...
class AddStrengthWorkoutEntry : AppCompatActivity(), DatePickerDialog.OnDateSetListener, MoodFragment.MoodFragmentListener, DragLinearLayout.OnViewSwapListener {
